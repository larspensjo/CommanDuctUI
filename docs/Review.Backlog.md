...
| [F-05-001](Review.05-Testability.md#f-05-001-progress_handler-splitter_handler-toggle_switch_handler-have-zero-tests) | Minor | testing | `progress_handler`, `splitter_handler`, `toggle_switch_handler` have zero tests | fixed | Phase 5 |
| [F-05-002](Review.05-Testability.md#f-05-002-dialog-form-validation-logic-is-pure-and-untested) | Major | testing | Dialog form validation logic is pure and untested | fixed | Phase 5 |
| [F-05-003](Review.05-Testability.md#f-05-003-event-translation-handlers-mix-hwnd-lookups-with-pure-reduction) | Major | testing | Event-translation handlers mix `HWND` lookups with pure reduction | fixed | Phase 5 |
| [F-05-004](Review.05-Testability.md#f-05-004-dialog-command-result-translation-has-no-tests) | Major | testing | Dialog command result-translation has no tests | fixed | Phase 5 |
| [F-05-005](Review.05-Testability.md#f-05-005-dialog-proc-state-transitions-are-trapped-inside-unsafe-extern-system-procs) | Minor | testing | Dialog proc state transitions are trapped inside unsafe `extern "system"` procs | fixed | Phase 5 |
| [F-05-006](Review.05-Testability.md#f-05-006-treeview-and-listbox-mutation-commands-have-no-end-to-end-coverage) | Major | testing | TreeView and ListBox mutation commands have no end-to-end coverage | fixed | Phase 5 |
...
| [F-05-011](Review.05-Testability.md#f-05-011-dialog-template-builders-are-pure-and-untested) | Major | testing | Dialog template builders are pure and untested | fixed | Phase 5 |
