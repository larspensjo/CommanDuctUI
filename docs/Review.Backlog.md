...
| [F-03-001](Review.03-Correctness.md#f-03-001-host-handle_event-panic-can-unwind-across-the-ffi-boundary-ub) | Critical | correctness | Host `handle_event` panic can unwind across the FFI boundary (UB) | open | Phase 3 |
| [F-03-002](Review.03-Correctness.md#f-03-002-listbox_handler-has-a-latent-post-create-gwlp_userdata-overwrite-hazard) | Major | correctness | `listbox_handler` has a latent post-create GWLP_USERDATA overwrite hazard | open | Phase 3 |
| [F-03-003](Review.03-Correctness.md#f-03-003-tab_bar_handler-has-the-same-post-create-gwlp_userdata-overwrite-hazard) | Major | correctness | `tab_bar_handler` has the same post-create GWLP_USERDATA overwrite hazard | open | Phase 3 |
| [F-03-004](Review.03-Correctness.md#f-03-004-menu-creation-leaks-hmenus-on-two-separate-error-paths) | Minor | correctness | Menu creation leaks `HMENU`s on two separate error paths | open | Phase 3 |
| [F-03-005](Review.03-Correctness.md#f-03-005-lowordhiword-helpers-on-lparam-do-not-sign-extend) | Minor | correctness | LOWORD/HIWORD helpers on LPARAM do not sign-extend | open | Phase 3 |
| [F-03-006](Review.03-Correctness.md#f-03-006-dark_border-and-panel_handler-subclasses-both-alias-gwlp_userdata-for-the-prev-wndproc) | Nit | correctness | `dark_border` and `panel_handler` subclasses both alias GWLP_USERDATA for the prev-wndproc | open | Phase 3 |
