...
const COLOR_DIALOG_BG: COLORREF = COLORREF(0x001C_1E1E); // #1E1E1C
const COLOR_DIALOG_TEXT: COLORREF = COLORREF(0x00F5_F9FA); // #FAF9F5
const COLOR_DIALOG_WARNING: COLORREF = COLORREF(0x004264C9); // #C96442
